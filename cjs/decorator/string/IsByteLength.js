...
function IsByteLength(min, max, validationOptions) {
    ...
    return ValidateBy_1.ValidateBy({
        ...
        validator: {
            ...
            defaultMessage: ValidateBy_1.buildMessage(eachPrefix => eachPrefix + translate["$property's byte length must fall into ($constraint1, $constraint2) range"], validationOptions),
        },
    }, validationOptions);
}
exports.IsByteLength = IsByteLength;
